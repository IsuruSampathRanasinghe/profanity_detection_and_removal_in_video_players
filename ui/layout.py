...
class LayoutMixin:
    ...
    def _build_ui(self):
        ...
        self.playback_section.columnconfigure(3, weight=0)
        self.playback_section.columnconfigure(4, weight=1)
        self.playback_section.columnconfigure(5, weight=0)
        self.playback_section.columnconfigure(6, weight=0)
        self.playback_section.columnconfigure(7, weight=0)
        self.playback_section.columnconfigure(8, weight=0)
        ...
        self.save_clean_btn = self._create_button(self.playback_section, "Save Clean Video", self.save_clean_video, "Primary.TButton")
        self.save_clean_btn.grid(row=0, column=2, sticky="w", padx=(0, 6))
        self._create_button(self.playback_section, "Pause", self.pause_video, "Warning.TButton").grid(row=0, column=3, sticky="w", padx=(0, 10))
        self.progress_scale = ttk.Scale(self.playback_section, from_=0, to=100, orient=self.tk.HORIZONTAL, command=self._on_seek)
        self.progress_scale.grid(row=0, column=4, sticky="ew", padx=(0, 10))
        ...
        self.timeline_marker_canvas.grid(row=1, column=4, sticky="ew", padx=(0, 10), pady=(4, 0))
        ...
        self._create_button(self.playback_section, "-5s", self.skip_backward, "Compact.TButton").grid(row=0, column=5, sticky="e", padx=(0, 6))
        self._create_button(self.playback_section, "+5s", self.skip_forward, "Compact.TButton").grid(row=0, column=6, sticky="e", padx=(0, 6))
        self._create_button(self.playback_section, "Stop", self.stop_video, "Danger.TButton").grid(row=0, column=7, sticky="e", padx=(0, 8))
