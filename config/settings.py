...
class Settings:
    ...
    profanity_dir: Path = base_dir / "data" / "profanity"
    profanity_file: Path = base_dir / "data" / "profanity" / "fallback.txt"
    profanity_en_file: Path = base_dir / "data" / "profanity" / "en.txt"
    profanity_si_file: Path = base_dir / "data" / "profanity" / "si.txt"
    profanity_ta_file: Path = base_dir / "data" / "profanity" / "ta.txt"
